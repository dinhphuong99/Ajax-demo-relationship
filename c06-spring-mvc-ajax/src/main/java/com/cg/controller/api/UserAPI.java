...
public class UserAPI {
    ...
    public UserDTO edit(@RequestBody UserDTO userDTO) {
        ...
        LocationRegionDTO locationRegionDTO = userDTO.getLocationRegion();
        LocationRegion locationRegionSaved = locationRegionService.save(locationRegionDTO.toLocationRegion());
        user.setLocationRegion(locationRegionSaved);
